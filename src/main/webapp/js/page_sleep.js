$(function() {
	...
	$("#img_div_1").append("<img src='images/sleep1.jpg' id='img1'>");
	$("#img_div_2").append("<img src='images/sleep2.jpg' id='img2'>");
	$("#img_div_3").append("<img src='images/sleep3.jpg' id='img3'>");
	//cover();
