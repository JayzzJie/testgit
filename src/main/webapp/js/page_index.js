$(function() {
	...
	$("#img_div_1").append("<img src='images/index1.jpg' id='img1'>");
	$("#img_div_2").append("<img src='images/index2.jpg' id='img2'>");
	$("#img_div_3").append("<img src='images/index3.jpg' id='img3'>");
	//cover();
